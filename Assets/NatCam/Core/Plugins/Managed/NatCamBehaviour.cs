...
namespace NatCamU.Core {
	...
	[CoreDoc(70)]
	public class NatCamBehaviour : MonoBehaviour
    { //This class is easily subclassed and overriden
        ...
        public FocusMode focusMode = FocusMode.Off;
		[Header("Debugging")]
		...
		public virtual void OnStart () {
		    ...
		    if (previewImages != null)
		    {
		        ...
		        {
		            previewImage.texture = NatCam.Preview;
		        }
		    }
